...
1. In order for FluentBit to work with L&C, you need to create a configuration file. Create a configuration file as shown below and upload it to Object Storage.
...
2. Create by adding a container to the template as shown below.
...
3. When you create a workload with that template, the logs generated by alpine can be searched and viewed in L&C.

#### Integration through Logstash

1. In order for Logstash to work with L&C, you need to create a configuration file. Create a configuration file as shown below and upload it to Object Storage.
