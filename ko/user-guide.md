...
| 오토 스케일러 | 리소스 사용률에 따라 워크로드의 작업 수를 자동 조정할 수 있습니다.<ul><li>증설/감축 조건: 감시할 리소스 지표, 기준값, 유지시간을 지정합니다.<li>최대/최소 작업 수: 자동 조정되는 최대/최소 작업 수를 설정합니다.</li><li>증설/감축 후 대기 시간: 증설/감축이 발생한 후 다시 발생하기까지 기다려야하는 시간을 설정합니다.</li></li></ul>예약 실행을 설정한 경우 오토스케일러를 사용할 수 없습니다. |
...
특정 워크로드를 클릭한 후 **실행 컨테이너** 탭에서 **작업 재시작**을 클릭하여 워크로드의 특정 작업의 재시작을 할 수 있습니다.
