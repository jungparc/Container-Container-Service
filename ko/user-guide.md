...
| 컨테이너 유형 | 컨테이너의 유형<br><ul><li>일반: 실행 상태가 유지되어야하는 컨테이너</li><li>초기화: 일반 컨테이너 실행 전 완료되어야 하는 컨테이너</li></ul>|
...
| 항목 | 설명 |
| --- | --- |
| 템플릿 | 템플릿의 이름<br><ul><li>**템플릿 선택**을 클릭하여 생성된 템플릿 중에서 선택합니다.</li><li>**템플릿 버전 선택**를 클릭하여 템플릿에 생성된 버전 중에서 선택합니다.</li><li>**템플릿 관리**을 클릭하여 새로운 템플릿을 생성합니다.</li></ul> |
